          ...
          <div class="inner02">
            ...
            <div class="inner_inner">
              ...
              foreach ($categories as $cat) {
                echo '<h2 class="area_h2" id="' . $i . '">' . esc_html($cat->name) . '</h2>';
                $children = get_terms('area_cat', 'hierarchical=0&parent=' . $cat->term_id);

                if ($children) {
                  foreach ($children as $child) {
                    echo '<h3 class="area_h3">' . esc_html($child->name) . '</h3>';
                    $catslug = $child->slug;
      ...
      <ul class="footer_iconlist">
        ...
        <li class="icon_sns twitter">
          <a href="https://twitter.com/YadeaJapan" target="blank">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40.148"
              height="36" viewBox="0 0 40.148 36">
              <defs>
              ...
              <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#a)">
                <path class="svg_tw"
                  d="M47.6,18A12.841,12.841,0,0,0,60.526,5.071c0-.2,0-.392-.013-.588a9.244,9.244,0,0,0,2.267-2.352,9.09,9.09,0,0,1-2.609.715,4.566,4.566,0,0,0,2-2.514,9.075,9.075,0,0,1-2.886,1.1A4.549,4.549,0,0,0,51.539,5.58,12.9,12.9,0,0,1,42.173.833,4.547,4.547,0,0,0,43.579,6.9a4.511,4.511,0,0,1-2.058-.569c0,.019,0,.038,0,.058a4.548,4.548,0,0,0,3.646,4.456,4.548,4.548,0,0,1-2.052.078,4.55,4.55,0,0,0,4.246,3.156,9.123,9.123,0,0,1-5.644,1.945,9.256,9.256,0,0,1-1.085-.064A12.866,12.866,0,0,0,47.6,18"
                  transform="translate(-31.63 9)" fill="#fff" />
              </g>
            </svg>
          </a>
        </li>
        <li class="icon_sns youtube">
          <a href="https://www.youtube.com/channel/UCavTW7Lq1xg2baWBJ-VF5LA" target="blank">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="43.714"
              height="36" viewBox="0 0 43.714 36">
              <defs>
              ...
              <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#a)">
                <path class="svg_yo"
                  d="M106.682,2.81A3.221,3.221,0,0,0,104.409.536C102.4,0,94.363,0,94.363,0S86.322,0,84.316.536A3.224,3.224,0,0,0,82.042,2.81,33.521,33.521,0,0,0,81.506,9a33.511,33.511,0,0,0,.536,6.188,3.224,3.224,0,0,0,2.274,2.274C86.322,18,94.363,18,94.363,18s8.041,0,10.046-.538a3.221,3.221,0,0,0,2.273-2.274A33.439,33.439,0,0,0,107.22,9a33.449,33.449,0,0,0-.538-6.19M91.791,12.857V5.142L98.472,9Z"
                  transform="translate(-72.51 9)" fill="#fff" />
              </g>
            </svg>
          </a>
        </li>
