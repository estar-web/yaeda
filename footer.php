<!-- バナー -->
<!-- <div class="ly_banner_area">
    <a href="<?php echo home_url(); ?>/lp/">
        <picture class="el_banner_img">
            <source srcset="<?php echo get_template_directory_uri(); ?>/img/banner/lp_banner_sp.png" media="(max-width:768px)" />
            <img src="<?php echo get_template_directory_uri(); ?>/img/banner/lp_banner_pc.png" alt="特定原付モデル 電動サイクル 3機種発売！" />
        </picture>
    </a>
</div> -->
...
<footer id="footer" class="footer noto">
    ...
    <div class="footer_top">
        <div class="footer_inner">
            <div class="btn_area">
                ...
                <a href="https://hasegawa-mobility.co.jp/" target="_blank">
                    <div class="store">
    ...
    <div class="footer_bottom">
        <div class="footer_inner">
            <!-- topに戻るボタン -->
            <!-- <div class="footer_btn_area pc">
                <a class="pagetop pc" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100">
                        <g transform="translate(-1249 -3114)">
                            <path class="btn_clear" d="M0,0H100V100H0Z" transform="translate(1249 3114)"
                                fill="#453e3e" />
                            <g transform="translate(208 -36)">
                                <path
                                    ...
                                    transform="translate(1083 3193.588) rotate(-90)" fill="#fff" /><text
                                    transform="translate(1116 3219)" fill="#fff" font-size="12"
                                    font-family="NotoSansJP-Medium, Noto Sans JP" font-weight="500">
            ...
            <!-- <div class="footer_btn_area sp">
                <div class="bnr_left sp">
                    <a href="" class="footer_bnr sp">
                        <img class="footer_bnr_img" src="<?php echo get_template_directory_uri(); ?>/img/banner/footer_bnr_sp.png" alt="">
                    </a>
                </div>
                <div class="bnr_right sp">
                    <a class="pagetop sp" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="58" viewBox="0 0 100 58"><g transform="translate(-1249 -3114)"><path d="M0,0H100V58H0Z" transform="translate(1249 3114)" fill="#453e3e"/><g transform="translate(230 -36)"><path d="M5.059,0l-.69.7L8.18,4.551H0v.941H8.135L4.367,9.3l.689.7L9.513,5.492h.033V5.458L10,5Z" transform="translate(1064 3174) rotate(-90)" fill="#fff"/><text transform="translate(1092 3194)" fill="#fff" font-size="11" font-family="NotoSansJP-Medium, Noto Sans JP" font-weight="500"><tspan x="-45.804" y="0">page top</tspan></text></g></g></svg>
                    </a>
                </div>
            </div> -->
            ...
            <ul class="footer_link">
                ...
                <li><a href="<?php echo home_url(); ?>/showroom">ショールーム案内</a></li>
                <li><a href="<?php echo home_url(); ?>/aftersupport">アフターサポート</a></li>
                <li><a href="<?php echo home_url(); ?>/business" target="_blank">法人向けサービス</a></li>
        ...
        <ul class="footer_iconlist">
            ...
            <li class="icon_sns tiktok">
                <a href="https://www.tiktok.com/@yadea_japan" target="blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="41" height="37" viewBox="0 0 41 37" fill="none">
                        ...
                        <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#a)">
                            <path class="svg_tk" d="M20.3982 9.01519C21.3797 9 22.3557 9.009 23.3305 9C23.3895 10.1481 23.8024 11.3175 24.6428 12.1292C25.4815 12.9611 26.6678 13.3419 27.822 13.4707V16.4908C26.7404 16.4554 25.6536 16.2304 24.672 15.7646C24.2445 15.5711 23.8463 15.3219 23.4565 15.0671C23.4514 17.2586 23.4655 19.4473 23.4424 21.6298C23.3839 22.6783 23.038 23.7218 22.4282 24.5858C21.4472 26.0241 19.7445 26.9618 17.9957 26.991C16.923 27.0523 15.8515 26.7598 14.9374 26.2209C13.4226 25.3277 12.3567 23.6925 12.2014 21.9375C12.1834 21.5623 12.1772 21.1877 12.1924 20.8215C12.3274 19.3944 13.0334 18.0293 14.1291 17.1006C15.3711 16.0189 17.1109 15.5036 18.7399 15.8085C18.7551 16.9194 18.7107 18.0293 18.7107 19.1402C17.9665 18.8994 17.0969 18.9669 16.4466 19.4186C15.9719 19.7263 15.6113 20.1977 15.4234 20.7309C15.2682 21.1112 15.3126 21.5336 15.3216 21.9375C15.4999 23.1683 16.6834 24.2027 17.9468 24.0907C18.7844 24.0817 19.587 23.5957 20.0235 22.8842C20.1647 22.635 20.3228 22.3802 20.3312 22.0871C20.4049 20.7456 20.3757 19.4096 20.3847 18.0681C20.3909 15.0446 20.3757 12.0296 20.3987 9.01575L20.3982 9.01519Z" fill="white" />
                        </g>
                    </svg>
                </a>
            </li>
